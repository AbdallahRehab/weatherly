...
- **Seed color:** `#2196F3` (used to derive `ColorScheme` via `ColorScheme.fromSeed` where applicable).
...
Import tokens via `package:weatherly/src/theme/theme_constants.dart`.
