...
Generated by [FlutterInit](https://flutterinit.com). Package: `com.example.weatherly`.
...
- Primary import barrel: `package:weatherly/src/imports/imports.dart`.
...
- For UI tokens and spacing, use **[DESIGN.md](../../Downloads/weatherly/DESIGN.md)**.
